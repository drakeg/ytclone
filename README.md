...
The next likely product sprint is publication-state management for creators, with filtering and bulk visibility actions. Higher-cost AWS services will be introduced only when usage justifies them.
