...
def _frame_score(path):
    with Image.open(path) as image:
        ...
        detail = edge_stats.mean[0]

    # Prefer frames with useful tonal range and visible detail. Contrast alone can
    # over-rank a blurry frame with large light/dark regions; edge energy gives
    # crisp, information-rich frames a modest advantage without adding OpenCV.
