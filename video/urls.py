...
urlpatterns = [
    ...
    path("community/replies/<int:reply_pk>/moderate/", community_views.community_reply_moderate, name="community_reply_moderate"),
    ...
    path("hashtags/<str:name>/", metadata_views.hashtag_detail, name="hashtag_detail"),
