...
urlpatterns = [
    ...
    path("bookmarks/", bookmark_views.video_bookmark_list, name="video_bookmark_list"), path("bookmarks/<int:pk>/delete/", bookmark_views.video_bookmark_delete, name="video_bookmark_delete"),
    ...
    path("history/", history_views.watch_history, name="watch_history"), path("history/clear/", history_views.watch_history_clear, name="watch_history_clear"), path("history/<int:pk>/remove/", history_views.watch_history_remove, name="watch_history_remove"),
]
