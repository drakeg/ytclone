...
from . import access_views, account_views, administration_views, category_views, channel_views, community_views, metadata_views, qa_views, reporting_views, search_views, shorts_views, subscription_views, upload_views, views
...
urlpatterns = [
    ...
    path("categories/", views.category_list, name="category_list"), path("categories/create/", category_views.category_create, name="category_create"), path("categories/create/inline/", category_views.category_create_inline, name="category_create_inline"), path("categories/<int:pk>/", views.category_detail, name="category_detail"), path("hashtags/<str:name>/", metadata_views.hashtag_detail, name="hashtag_detail"),
    path("search/", views.search, name="search"), path("search/suggestions/", search_views.suggestions, name="search_suggestions"), path("filter/", views.filter_videos, name="filter"), path("profile/<str:username>/", views.user_profile, name="user_profile"), path("profile/<str:username>/edit/", views.edit_profile, name="edit_profile"), path("upload/", upload_views.upload_video, name="upload"),
